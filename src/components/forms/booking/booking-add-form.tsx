...
export function BookingAddForm({
  ...
  const daysClosed = businessHours
    ...
    const form = useForm<AddBookingInput>({
      ...
      defaultValues: {
        type: "veterinarian", // Changed from "weterynarz" to "veterinarian"
        date: undefined,
        time: undefined,
        firstName: "",
        lastName: "",
        ...
        phone: "",
        message: "",
        status: "unconfirmed", // Changed from "niepotwierdzone" to "unconfirmed"
      },
    })
                ...
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      <SelectTrigger className="capitalize">
                        <SelectValue
                          placeholder={field.value || "Choose a time"}
                        />
                      </SelectTrigger>
