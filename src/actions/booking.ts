...
export async function getAllBookings(): Promise<Booking[] | null> {
  try {
    ...
    console.error(error)
    // throw new Error("Error while loading reservations")
...
export async function addBooking(
  ...
  try {
    ...
    console.error(error)
    throw new Error("Error while adding a reservation")
  }
}
...
export async function checkIfBookingExists(
  ...
  try {
    ...
    console.error(error)
    throw new Error("Error while checking reservations")
  }
}
...
export async function deleteBooking(
  ...
  try {
    ...
    console.error(error)
    throw new Error("Error while deleting the reservation")
  }
}
...
export async function filterBookings(rawInput: FilterBookingsInput) {
  try {
    ...
    console.error(error)
    throw new Error("Error while filtering reservations")
  }
}
